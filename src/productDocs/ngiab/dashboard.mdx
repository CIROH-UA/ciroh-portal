...
import { GitHubDashboard, RepoListSectionElement } from '../../components/GitHubDashboard.js';
import { RepoDiv, OrgDiv, RepoWorkflowsDiv } from '../../components/GitHubShards.js';
